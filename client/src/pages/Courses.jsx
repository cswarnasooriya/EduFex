        ...
        <div className='w-4/5 m-auto'>
          <div className='heading mb-16'>
            <h1 className='text-3xl font-semibold text-black'>
              Find The Right <br />
              Online Course For You with EduFex
            </h1>
            <span className='text-sm mt-4 block'>you don't have to struggle alone, you've got our assistance and help.</span>
          </div>
                ...
                <div className='text p-3'>
                  <div className='flex justify-between items-center'>
                    <div className='flex items-center'>
                      <FaBook />
                      <span className='text-[14px] ml-2'> 15 lessons</span>
                    </div>
                    <div className='flex items-center'>
                      <AiFillStar className='text-orange-500' />
                      <span className='text-[14px] ml-2'> 4.80(2)</span>
                    </div>
                  </div>
                  ...
                  <div className='user flex items-center'>
                    ...
                    <span className='text-[14px] ml-2'> Pradeep</span>
                  </div>
                </div>
