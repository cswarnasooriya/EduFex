...
import heroImg from "../components/assets/images/hero_img.png"
        ...
        <div className='container'>
          <div className='flex items-center justify-center md:flex-col'>
            <div className='left w-1/2 text-black md:w-full'>
              ...
              <h1 className='text-5xl md:text-5xl leading-tight text-black font-semibold'>
                Welcome to <br /> Our Online Instruction <br /> Platform
              </h1>
              
              <h3 className='text-2xl mt-3'>Unlimited access to all 20+ instructors.</h3>
              <span className='text-[16px]'>3 Passes (with access to all classes) for LKR 150,000</span>

              <div className='relative text-gray-600 focus-within:text-gray-400 mt-5 mb-5'>
                <input type='search' className='py-4 text-sm  bg-white rounded-md pl-10 focus:outline-none ' placeholder='Search...' autocomplete='off' />
                <span className='absolute inset-y-0 left-0 flex items-center pl-2'>
                  <button type='submit' className='p-4 focus:outline-none focus:shadow-outline'>
                    <FiSearch />
                  </button>
                </span>
              </div>
              <span className='text-[15px]'>You are guaranteed to find something that`s right for you.</span>
            </div>
            <div className='right w-1/2 md:w-full relative'>
              ...
              <div className='content'>
                ...
                <button className='bg-white shadow-md absolute top-32 right-32 z-30 p-2 flex items-center rounded-md'>
                  ...
                  <div className='text flex flex-col items-start px-4'>
                    <span className='text-sm text-black'>Free Education Centers</span>
                    <span className='text-[12px]'>All For Free Yours</span>
                  </div>
                </button>
              </div>
            </div>
